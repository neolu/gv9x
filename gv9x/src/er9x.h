...
//#define MIX_SW_ROLL_CHAN (CHOUT_BASE+NUM_CHNOUT+NUM_VIRTUAL) // GVA:Rotary switch
#define MIX_INC_ROTARY_SW (CHOUT_BASE+NUM_CHNOUT+1)
#define MIX_DEC_ROTARY_SW (CHOUT_BASE+NUM_CHNOUT+2)


#define NUM_XCHNRAW (CHOUT_BASE+NUM_CHNOUT+NUM_VIRTUAL+NUM_TELEMETRY) // NUMCH + P1P2P3+ AIL/RUD/ELE/THR + MAX/FULL + CYC1/CYC2/CYC3
//GVA + 13
